; Listing generated by Microsoft (R) Optimizing Compiler Version 19.43.34808.0 
	...
	TITLE	D:\lecture_debug_release\crash_demo_windbg\vectorization\vectorization.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	SEGMENT
$T1 = -24000048						; size = 8
_duration$ = -24000040					; size = 8
_end$ = -24000032					; size = 8
_start$ = -24000024					; size = 8
_size$ = -24000016					; size = 4
_i$2 = -24000012					; size = 4
_i$3 = -24000008					; size = 4
_result$ = -24000004					; size = 8000000
_data2$ = -16000004					; size = 8000000
_data1$ = -8000004					; size = 8000000
__$ArrayPad$ = -4					; size = 4
_main	PROC
; File D:\lecture_debug_release\crash_demo_windbg\vectorization\vectorization.cpp
; Line 4
	push	ebp
	mov	ebp, esp
	mov	eax, 24000048				; 016e3630H
	call	__chkstk
	mov	eax, DWORD PTR ___security_cookie
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
; Line 5
	mov	DWORD PTR _size$[ebp], 1000000		; 000f4240H
; Line 9
...
$LN4@main:
	cmp	DWORD PTR _i$2[ebp], 1000000		; 000f4240H
	jge	SHORT $LN3@main
; Line 10
	mov	ecx, DWORD PTR _i$2[ebp]
	movsd	xmm0, QWORD PTR __real@3ff0000000000000
	movsd	QWORD PTR _data1$[ebp+ecx*8], xmm0
; Line 11
	mov	edx, DWORD PTR _i$2[ebp]
	movsd	xmm0, QWORD PTR __real@4000000000000000
	movsd	QWORD PTR _data2$[ebp+edx*8], xmm0
; Line 12
	jmp	SHORT $LN2@main
$LN3@main:
; Line 14
...
$LN7@main:
	cmp	DWORD PTR _i$3[ebp], 1000000		; 000f4240H
	jge	SHORT $LN6@main
; Line 16 optimizations
	mov	edx, DWORD PTR _i$3[ebp]
	mov	eax, DWORD PTR _i$3[ebp]
	movsd	xmm0, QWORD PTR _data1$[ebp+edx*8]
	addsd	xmm0, QWORD PTR _data2$[ebp+eax*8]
	mov	ecx, DWORD PTR _i$3[ebp]
	movsd	QWORD PTR _result$[ebp+ecx*8], xmm0
; Line 17
	jmp	SHORT $LN5@main
$LN6@main:
; Line 18
