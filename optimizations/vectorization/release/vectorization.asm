...
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\xstring
; Line 474
	vmovdqu	XMMWORD PTR __Buf$[ebp], xmm0
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\xlocnum
; Line 1379
	mov	DWORD PTR ___$ReturnUdt$GSCopy$1$[ebp], eax
...
; File C:\Program Files (x86)\Windows Kits\10\include\10.0.22621.0\ucrt\corecrt_math.h
; Line 851
	vmovsd	xmm1, QWORD PTR __Val$[ebp]
	vmovaps	xmm0, xmm1
	vandpd	xmm0, xmm0, QWORD PTR __xmm@7fffffffffffffff7fffffffffffffff
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\xlocnum
; Line 1389
	vcomisd	xmm0, QWORD PTR __real@4202a05f20000000
...
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\xlocnum
; Line 1399
	vmovsd	xmm0, QWORD PTR __Val$[ebp]
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\xstring
; Line 2346
...
$LN26@do_put:
	vpxor	xmm0, xmm0, xmm0
	vmovdqu	XMMWORD PTR __Str$7[ebp], xmm0
; Line 836
...
$LN215@do_put:
; Line 1297
	vmovdqu	xmm0, XMMWORD PTR $T6[ebp]
	vmovdqu	XMMWORD PTR __Str$7[ebp], xmm0
	vmovq	xmm0, QWORD PTR $T6[ebp+16]
	lea	ecx, DWORD PTR $T6[ebp]
	mov	DWORD PTR $T6[ebp+16], 0
	vmovq	QWORD PTR __Str$7[ebp+16], xmm0
...
$T3 = -16						; size = 1
__$EHRec$ = -12						; size = 12
_data1$ = 0						; size = 8000000
_data2$ = 0						; size = 8000000
__$ArrayPad$ = 8000000					; size = 4
_main	PROC						; COMDAT
; File D:\lecture_debug_release\crash_demo_windbg\vectorization\vectorization.cpp
; Line 4
	push	ebp
	lea	ebp, DWORD PTR [esp-8000004]
...
; Line 10
	...
	vmovsd	QWORD PTR _data1$[ebp], xmm0
	vmovsd	xmm0, QWORD PTR __real@4000000000000000
	mov	ecx, 1999998				; 001e847eH
	lea	esi, DWORD PTR _data1$[ebp]
	lea	edi, DWORD PTR _data1$[ebp+8]
	rep movsd
; Line 14 optimization
	lea	eax, DWORD PTR _start$[ebp]
	mov	ecx, 1999998				; 001e847eH
	vmovsd	QWORD PTR _data2$[ebp], xmm0
	lea	esi, DWORD PTR _data2$[ebp]
	lea	edi, DWORD PTR _data2$[ebp+8]
	rep movsd
	push	eax
...
; Line 300
	...
	sbb	eax, DWORD PTR _start$[ebp+4]
; Line 108
	push	0
	push	1000000					; 000f4240H
	push	eax
...
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\xstring
; Line 474
	vmovdqu	XMMWORD PTR $T2[ebp], xmm0
; Line 498
...
; Line 2816
	vmovdqu	xmm0, XMMWORD PTR [eax]
	vmovdqu	XMMWORD PTR [esi+8], xmm0
; Line 2794
	jmp	SHORT $LN25@use_facet
$LN24@use_facet:
	xor	esi, esi
...
; Line 281
	...
	vmovq	xmm0, QWORD PTR [eax+32]
	vmovq	QWORD PTR [edx+32], xmm0
...
; Line 499
	mov	DWORD PTR [esi+20], 0
; Line 887
	mov	DWORD PTR __New_capacity$1[esp+12], 31	; 0000001fH
; Line 888
	call	??$_Allocate_for_capacity@$0A@@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@CAPADAAV?$allocator@D@1@AAI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Allocate_for_capacity<0>
; Line 892
...
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\__msvc_string_view.hpp
; Line 95
	vmovdqu	xmm0, XMMWORD PTR ?_Iostream_error@?4??message@_Iostream_error_category2@std@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@H@Z@4QBDB
	vmovdqu	XMMWORD PTR [eax], xmm0
...
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\xstring
; Line 1262
	vmovq	xmm0, QWORD PTR $T2[ebp+16]
	vmovdqu	xmm1, XMMWORD PTR $T2[ebp]
	vmovq	QWORD PTR $T6[ebp+16], xmm0
; Line 434
...
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\xstring
; Line 1262
	vmovdqu	XMMWORD PTR $T6[ebp], xmm1
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\vcruntime_exception.h
; Line 62
	call	___std_exception_copy
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\xstring
...
; Line 474
	vmovdqu	XMMWORD PTR [esi], xmm0
; Line 1262
	vmovdqu	xmm0, XMMWORD PTR __Message$[ebp]
; Line 498
	mov	DWORD PTR [esi+16], 0
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\system_error
; Line 469
...
; Line 1262
	vmovdqu	XMMWORD PTR [esi], xmm0
	vmovq	xmm0, QWORD PTR __Message$[ebp+16]
...
; Line 62
	...
	mov	DWORD PTR __InitData$1[esp+16], edx
	push	eax
...
; Line 62
	lea	eax, DWORD PTR __InitData$[esp+12]
...
; Line 850
	sub	esp, 8
; Line 851
	vmovsd	xmm0, QWORD PTR __X$[esp+4]
	vandpd	xmm0, xmm0, QWORD PTR __xmm@7fffffffffffffff7fffffffffffffff
	vmovsd	QWORD PTR tv68[esp+8], xmm0
