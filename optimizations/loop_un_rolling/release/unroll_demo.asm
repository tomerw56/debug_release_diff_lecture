...
PUBLIC	??_C@_05IACBCAIA@Sum?3?5@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_05IACBCAIA@Sum?3?5@
CONST	SEGMENT
??_C@_05IACBCAIA@Sum?3?5@ DB 'Sum: ', 00H		; `string'
CONST	ENDS
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__catchsym$??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@N@Z$7 DD 040H
	DD	00H
	DD	00H
...
__tryblocktable$??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@N@Z DD 02H
	...
	DD	03H
	DD	01H
	DD	FLAT:__catchsym$??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@N@Z$7
...
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\xlocnum
; Line 1269
	movsd	xmm0, QWORD PTR __Val$[esp-4]
	sub	esp, 8
	mov	eax, DWORD PTR [ecx]
	movsd	QWORD PTR [esp], xmm0
...
;	COMDAT _main
_TEXT	SEGMENT
_sum$1$ = -800000032					; size = 8
_end$ = -800000024					; size = 8
_start$ = -800000016					; size = 8
_data$ = -800000008					; size = 800000000
__$ArrayPad$ = -4					; size = 4
_main	PROC						; COMDAT
...
; Line 4
	...
	mov	eax, DWORD PTR ___security_cookie
	xor	eax, esp
	mov	DWORD PTR __$ArrayPad$[esp+800000056], eax
	push	esi
	xorps	xmm0, xmm0
; Line 15
	lea	eax, DWORD PTR _start$[esp+800000060]
	push	edi
	movsd	QWORD PTR _sum$1$[esp+800000064], xmm0
	lea	esi, DWORD PTR _data$[esp+800000064]
	movsd	xmm0, QWORD PTR __real@3ff0000000000000
	lea	edi, DWORD PTR _data$[esp+800000072]
	movsd	QWORD PTR _data$[esp+800000064], xmm0
	mov	ecx, 199999998				; 0bebc1feH
	rep movsd
	push	eax
...
; Line 17 
; optimization
	movsd	xmm0, QWORD PTR _data$[esp+eax*8+800000072]
	addsd	xmm0, QWORD PTR _data$[esp+eax*8+800000064]
	addsd	xmm0, QWORD PTR _data$[esp+eax*8+800000080]
	addsd	xmm0, QWORD PTR _data$[esp+eax*8+800000088]
	add	eax, 4
	addsd	xmm0, QWORD PTR _sum$1$[esp+800000064]
	movsd	QWORD PTR _sum$1$[esp+800000064], xmm0
	cmp	eax, 100000000				; 05f5e100H
	jl	SHORT $LL7@main
; Line 19
	lea	eax, DWORD PTR _end$[esp+800000064]
	push	eax
	call	?now@steady_clock@chrono@std@@SA?AV?$time_point@Usteady_clock@chrono@std@@V?$duration@_JU?$ratio@$00$0DLJKMKAA@@std@@@23@@23@XZ ; std::chrono::steady_clock::now
; Line 21
	movsd	xmm1, QWORD PTR _sum$1$[esp+800000068]
	push	ecx
	movsd	QWORD PTR [esp], xmm1
	push	OFFSET ??_C@_05IACBCAIA@Sum?3?5@
...
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\__msvc_chrono.hpp
; Line 221
	mov	ecx, DWORD PTR _end$[esp+800000068]
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\__msvc_ostream.hpp
; Line 191
	add	esp, 4
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\__msvc_chrono.hpp
; Line 221
	sub	ecx, DWORD PTR _start$[esp+800000064]
	mov	eax, DWORD PTR _end$[esp+800000068]
	sbb	eax, DWORD PTR _start$[esp+800000068]
; File D:\lecture_debug_release\crash_demo_windbg\loop_un_rolling\unroll_demo.cpp
; Line 22
...
; File D:\lecture_debug_release\crash_demo_windbg\loop_un_rolling\unroll_demo.cpp
; Line 24
	mov	ecx, DWORD PTR __$ArrayPad$[esp+800000076]
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\include\__msvc_ostream.hpp
; Line 191
	add	esp, 12					; 0000000cH
; File D:\lecture_debug_release\crash_demo_windbg\loop_un_rolling\unroll_demo.cpp
