...
PUBLIC	__real@4023b81d7dbf4880
...
CONST	ENDS
;	COMDAT __real@4023b81d7dbf4880
CONST	SEGMENT
__real@4023b81d7dbf4880 DQ 04023b81d7dbf4880r	; 9.8596
CONST	ENDS
...
; Line 12
	lea	eax, DWORD PTR _start$[esp+24]
	push	eax
	...
	movsd	xmm1, QWORD PTR __real@4023b81d7dbf4880
	add	esp, 4
...
; Line 16
	...
	movsd	QWORD PTR _sum$1$[esp+24], xmm0
	push	eax
	call	?now@steady_clock@chrono@std@@SA?AV?$time_point@Usteady_clock@chrono@std@@V?$duration@_JU?$ratio@$00$0DLJKMKAA@@std@@@23@@23@XZ ; std::chrono::steady_clock::now
; Line 18
	movsd	xmm0, QWORD PTR _sum$1$[esp+28]
	push	ecx
	movsd	QWORD PTR [esp], xmm0
